...
public class PedidosActivos extends javax.swing.JFrame {

    /**
     * Creates new form PedidosActivos
     */
    public PedidosActivos() throws IOException {
        initComponents();
    }
    ...
    private void initComponents() throws IOException {
         ...
         * en la cola del server y se los muestra
         * al administrador.
         */
        new Thread(() -> {
            while (active) {
                try {
                    Sockets.out.println("getColaPedidos");
                    String inputLine;
                    String timerPedidoActual = "Timer de pedido actual: " + Sockets.in.readLine();
                    String timerPedidoTotal = "Timer de cola de pedidos: " + Sockets.in.readLine();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PedidosActivos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new PedidosActivos().setVisible(true);
                } catch (IOException e) {
